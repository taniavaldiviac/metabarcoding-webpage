...
├── raw_fastqs/          # Archivos FASTQ originales (no modificar)
├── for_dada2/           # FASTQs recortados con cutadapt, listos para DADA2
...
└── metadata/            # Archivos de configuración (primers, metadatos, BD taxonómica)
```
