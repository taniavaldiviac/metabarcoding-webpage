...
- `locus_shorthand` — Identificador corto (ej. `12S`). Se usa para filtrar archivos FASTQ y nombrar outputs
:::
...
**Parámetros del amplicón**

- `amplicon_length` — Longitud esperada del amplicón (bp)
- `max_trim` — Longitud máxima de truncamiento (evita perder el solapamiento F/R)
