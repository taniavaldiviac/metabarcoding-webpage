...
- `locus_shorthand` — Identificador corto del marcador (ej. `12S`)

**Primers**

- `seq_f` / `seq_r` — Secuencias de primers forward y reverse
- `F_qual` / `R_qual` — Longitud del primer para Cutadapt

**Amplicón**

- `amplicon_length` — Longitud esperada (bp)
- `max_trim` — Truncamiento máximo permitido
- `overlap` — Solapamiento mínimo para el merge

**Base de datos**

- `db_name` — Archivo FASTA de referencia taxonómica
...
**Información ecológica y geográfica**
...
- `filename_base` — Nombre del archivo tal como lo entrega el secuenciador
- `rename_to` — Nombre generado para entrar al pipeline (ej. `12S-GC-001-d1_1_S1_L001`)
