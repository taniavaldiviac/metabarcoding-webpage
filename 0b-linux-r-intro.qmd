...
En el servidor del curso verás algo como:

```
(base) tvaldivia@a240:~$
```

- `(base)` — entorno conda activo (el base por defecto; hay que cambiarlo a `metabarcoding`)
- `tvaldivia` — tu nombre de usuario
- `a240` — nombre del servidor
- `~` — estás en tu directorio home
