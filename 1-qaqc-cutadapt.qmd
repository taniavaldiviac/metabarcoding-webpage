...
### Visualizar el conteo en R

Desde R, puedes leer el archivo y hacer una gráfica rápida para detectar muestras con pocas lecturas:
...
# Separar muestra y sentido (R1/R2)
conteo <- conteo %>%
  mutate(
...
La línea roja marca 10,000 lecturas — muestras por debajo de ese umbral merecen revisión antes de continuar.
