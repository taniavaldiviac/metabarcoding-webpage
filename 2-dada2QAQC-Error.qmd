...
# El archivo se llama: AAAAMMDD_HHMM_12S_checkpoint2_Dereps.RData
# Listar para ver el nombre exacto de tu corrida:
list.files(file.path(output_location, "rdata_output"), pattern = "checkpoint2_Dereps")

# Reemplaza con el nombre de tu archivo:
load(file.path(output_location, "rdata_output", "20260325_1430_12S_checkpoint2_Dereps.RData"))
