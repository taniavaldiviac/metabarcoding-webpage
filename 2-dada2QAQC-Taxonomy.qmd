...
El `.RData` contiene los tres objetos principales para phyloseq (`asv_mat`, `tax_mat`, `sample_meta`) más objetos adicionales para reproducibilidad: `track`, tablas de taxonomía completas y los parámetros del run. El siguiente paso es construir el objeto phyloseq para análisis de diversidad (Día 4).
