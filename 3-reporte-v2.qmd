...
La base de datos de referencia (e.g. MiFish) contiene especies de todo el mundo. DADA2 asigna la especie con mayor similitud de secuencia, pero esa especie puede no distribuirse en el Golfo de California. La curación se hace en dos pasos:

**Paso 1 — Correcciones manuales:** Algunas asignaciones requieren ajustes puntuales basados en conocimiento experto. Por ejemplo, el género *Balistes* en el GC corresponde a *B. polylepis*, y algunas familias necesitan reclasificación a nivel de orden siguiendo la taxonomía actualizada.

**Paso 2 — Curación geográfica automática:** Contrastamos cada asignación contra una lista de especies documentadas para el Golfo de California (`Fish_speciesGC.csv`):
