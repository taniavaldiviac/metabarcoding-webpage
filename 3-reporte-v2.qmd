...
message("Especies en el gráfico: ", n_sp)

# Generar paleta con suficientes colores distintos combinando múltiples fuentes
base_colors <- c(
...
# Si aún no alcanzan, completar con rainbow_hcl
if (n_sp > length(base_colors)) {
  extra <- colorspace::rainbow_hcl(n_sp - length(base_colors), c = 90, l = 55)
  base_colors <- c(base_colors, extra)
}
pal_sp <- base_colors[1:n_sp]
