...
```{r}
uc_file <- file.path("otus_vsearch/fish_0.97.uc")
...
```{r}
# Cargar objeto phyloseq del pipeline DADA2
rdata_in <- file.path("final_data/rdata_output/phyloseq_inputs.RData")
load(rdata_in)

ps.asv <- ps  # ajustar según el nombre del objeto en tu .RData
ps.asv
```
